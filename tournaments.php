				...
				<div class="container">
						<div class="row">
									<div class="panel-group topicList col-md-9" id="accordion">
											<?php foreach(Controller::getTournaments() as $tourn) {?>
											<br/>
																	...
																	<div class="row">
																		...
																		<div class="col-md-offset-1 col-md-7">
																			<table class="table detailsTable">
																				<tbody>
																					<tr><td class="detailsTableHeading">Type:</td> <td><?php echo $tourn->getType()?></td></tr>
																					<tr><td class="detailsTableHeading">Surface :</td> <td><?php echo $tourn->getSurface()?></td></tr>
																					<tr><td class="detailsTableHeading">Place :</td><td><?php echo $tourn->getPlace()?></td></tr>
																					<tr><td class="detailsTableHeading">Month :</td><td><?php echo $tourn->getMonth()?></td></tr>
																					<tr><td class="detailsTableHeading">Finance :</td> <td><?php echo $tourn->getFinance()?></td></tr>
																				</tbody>
																			</table>
																		</div>
																	</div>
